...
function resizeCanvas() {
  ...
  dom_canvas.width = size;
  dom_canvas.height = size;
}
...
dom_canvas.addEventListener("touchend", (e) => {
  ...
  if (absX > absY) {
    if (dx > 0 && !KEY.ArrowLeft) KEY.ArrowRight = true;
    else if (dx < 0 && !KEY.ArrowRight) KEY.ArrowLeft = true;
  } else {
    if (dy > 0 && !KEY.ArrowUp) KEY.ArrowDown = true;
    else if (dy < 0 && !KEY.ArrowDown) KEY.ArrowUp = true;
  }
});
class Snake {
  constructor(i, type) {
